...
/**
 * Description of GroupListItemManagement
 *
 * @author testy
 */
...
class GroupListItemManagement {
    ...
    public static function actionCreate() {
        sec_session_start();
        if (isset($_POST['item_name']) && isset($_POST['item_details']) && isset($_POST['due_date']) && isset($_POST['current_date']) && isset($_POST['file']) && isset($_POST['list_id']) && isset($_POST['priority']) && isset($_POST['personal'])) {
    ...
    public static function actionEdit() {
         if (isset($_POST['item_name']) && isset($_POST['item_details']) && isset($_POST['due_date']) && isset($_POST['file']) && isset($_POST['list_item_id']) && isset($_POST['priority']) && isset($_POST['personal'])) {
            ...
            if (is_array($list_item)) {
                foreach ($list_item as $list_item) {
                    ...
                    $list_item->setIs_personal($is_personal);
                }
            }
